...
keymap("n", "m1", [[<cmd>lua require("harpoon.ui").nav_file(1)<cr>]], { desc = "Goto File At Position 1" })
...
keymap("n", "m5", [[<cmd>lua require("harpoon.ui").nav_file(5)<cr>]], { desc = "Goto File At Position 5" })
keymap("n", "]v", [[<cmd>lua require("harpoon.ui").nav_next()<cr>]], { desc = "Next Harpoon File" })
keymap("n", "[v", [[<cmd>lua require("harpoon.ui").nav_prev()<cr>]], { desc = "Prev Harpoon File" })
